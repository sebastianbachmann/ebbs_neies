defmodule EbbsNeiesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(EbbsNeiesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(EbbsNeiesWeb.Gettext, "errors", msg, opts)
    end
  end
